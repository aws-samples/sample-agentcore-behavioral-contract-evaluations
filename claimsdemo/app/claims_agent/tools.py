"""Simulated tools for the claims processing demo agent.

Embedded lookup data simulates a formulary database and a coverage policy
API. In production these would call real services. All data is synthetic.
"""
